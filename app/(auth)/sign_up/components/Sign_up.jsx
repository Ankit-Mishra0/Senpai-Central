...
const Sign_up = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen relative">
      <h2 className="text-3xl md:text-5xl text-gray-300 m-2">SIGN UP</h2>
      <div className="flex flex-row bg-white w-[90%] lg:w-[70%] lg:h-[80%] h-auto rounded-lg">
        ...
        <div className="lg:flex-[0.54] flex-[1] bg-gradient-to-br from-gray-400 to-gray-800 border-l-2 border-black  lg:rounded-r-lg flex flex-col ">
          ...
          <form>
            ...
            <div className="w-full flex justify-center mt-3">
              <button className="bg-blue-700 w-auto p-3 rounded-lg text-white mt-5 hover:bg-blue-800 transition-all duration-300 ease-in-out">
                SIGN UP
              </button>
            </div>
            ...
            <div className="flex flex-row  items-center h-max mt-5 p-2.5 justify-center">
              <div className="flex w-[60%] items-center justify-center px-3 py-2  hover:bg-slate-800 hover:text-white rounded-md shadow-md hover:shadow-lg bg-white transition-all duration-300 ease-in-out">
                <button onClick={() => console.log("clicking")}>
                  <GoogleIcon className="text-red-600 !size-8 mr-4 mb-1 ml-1" />{" "}
                  Google
                </button>
              </div>
            </div>
            <div className="ml-4  font-bold">
              <h6>
                ...
                <Link
                  href="/login"
                  className="text-blue-300 text-[20px] ml-2 hover:text-blue-800 hover:underline transition-all duration-300 ease-in-out"
                >
                  Sign-In
                </Link>
              </h6>
